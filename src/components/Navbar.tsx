...
=======
    <section className="flex flex-row-reverse items-center justify-between fixed bottom-1 bg-paddBlueDark text-paddLight h-12 w-11/12 mx-auto inset-x-0 rounded-md md:w-8/12 md:h-10 lg:mx-0 lg:flex-col lg:h-full lg:w-12 lg:bottom-0 lg:left-0 lg:rounded-none lg:rounded-r-md overflow-hidden box-border p-1 ">
