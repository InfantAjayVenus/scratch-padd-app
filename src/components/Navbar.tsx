...
export const Navbar = (props: NavbarProps) => {
  return (
    <section className="flex flex-row-reverse items-center justify-between fixed z-50 bottom-0 bg-paddBlueDark text-paddLight h-12 w-full md:h-10 lg:flex-col lg:h-full lg:w-12 lg:left-0 lg:top-10">
